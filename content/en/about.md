...
about_support:
  ...
  title: "Support through the full pallet decision"
  description: "A practical framework for distributors, automation integrators and warehouse operators."
  items:
    - { icon: "solution", title: "Application review", description: "We convert equipment and rack conditions into a clear pallet requirement sheet." }
    - { icon: "quality", title: "Material control", description: "HDPE material, molding conditions, steel reinforcement and appearance are checked by batch." }
    - { icon: "manufacturing", title: "Injection molding", description: "Stable molds and controlled process settings support dimensional consistency across repeat orders." }
    - { icon: "application", title: "AS/RS matching", description: "Runner geometry, support span, entry direction and sensor interfaces are confirmed together." }
    - { icon: "support", title: "Customization", description: "Colors, logo, printing, identification and reinforcement can be configured by project." }
    - { icon: "delivery", title: "Export coordination", description: "We support sampling, inspection, packing, documentation and shipment milestones." }
about_production:
  enable: true
